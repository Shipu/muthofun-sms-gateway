...
use Shipu\MuthoFun\Http\RequestHandler;
use Shipu\MuthoFun\Http\Response;
...
abstract class AbstractApi
{
    ...
    public function __construct()
    {
        ...
        $this->sendingUrl = $this->setSendingUrl();

        $this->defaultHeaders = $this->setDefaultHeaders();

        $this->client = new RequestHandler($this->baseUrl);
    }
    ...
    abstract protected function setSendingUrl();
